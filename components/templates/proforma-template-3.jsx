...
const InvoiceFooter = () => (
  <footer className="text-xs text-blue-700 mt-4 pt-4 border-t-2 border-blue-300 bg-white">
  ...
  <div className="mt-auto">
    <section className="pt-8 flex justify-between items-end">
      <div className="text-xs">
        <div className="bg-blue-600 text-white font-bold py-1 px-3 mb-2 text-[11px]">
          PAYMENT METHOD:
        </div>
